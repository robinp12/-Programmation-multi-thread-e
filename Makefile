...
task1: philosophers1 producerConsumer1 readerWriter1 perf1 graphs1

task2: test_and_set test_test_and_set perf2 graphs2
...
test_test_and_set:
		gcc -I -Wall -Werror -std=c99 task_2/test_test_and_set.c -o out/task_2/test_test_and_set.o -pthread
perf2:
